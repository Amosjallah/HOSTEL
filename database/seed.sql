-- =============================================================================
-- KTU Student Hostel Portal — Seed Data (PostgreSQL / Supabase)
-- Realistic demo data for KTU area, Koforidua, Eastern Region, Ghana.
-- KTU Campus GPS: latitude 6.0900, longitude -0.2573
-- =============================================================================

-- NOTE: Passwords are bcrypt hashes of simple demo passwords shown in README.
--   Admin:    admin@hostelportal.edu.gh     → password: Admin@1234
--   Landlords: [name]@gmail.com             → password: Landlord@1
--   Students:  [name]@ktu.edu.gh            → password: Student@1

-- =============================================================================
-- USERS: 1 Admin + 5 Landlords + 6 Students
-- =============================================================================
...
-- =============================================================================
-- PROPERTIES: 18 listings around KTU campus area
-- KTU GPS: 6.0900, -0.2573  (Koforidua Technical University, Eastern Region)
-- Neighborhoods: Adweso, Nsukwao, Effiduase, Oyoko, Ashanti Nkwanta, Akwadum
-- =============================================================================
...
-- Kwame's properties (landlord user_id = 2)
...
-- Abena's properties (landlord user_id = 3)
...
-- Kofi's properties (landlord user_id = 4)
...
-- Ama's properties (landlord user_id = 5)
...
-- Pending listing (not yet approved by admin)
...
-- =============================================================================
-- PROPERTY IMAGES (sample paths — real images served from Supabase Storage)
-- =============================================================================
...
-- Active pending booking (property 9 is already 'Pending')
(12, 9, 'Pending',
 NOW() - INTERVAL '2 hours', NOW() + INTERVAL '22 hours', NULL);

-- =============================================================================
-- REVIEWS (only for Approved bookings — gate enforced in app layer)
-- =============================================================================
...
-- Landlord notified of booking request
(2, 'BookingRequest',
...
-- Active pending hold notification
(4, 'BookingRequest',
